...
proc crate_random_cbr_connection { n_pair seed_val cbr_size } {
global ns
#set cbr_size 500
set cbr_interval ($cbr_size*8)/80000
puts "$cbr_interval"
set start_time 5
set stop_time 25
#random set
...
if { $argc != 3} {
    puts "baby you are wrong"
} else {
    crate_random_cbr_connection  [lindex $argv 0] [lindex $argv 1] [lindex $argv 2]
}
